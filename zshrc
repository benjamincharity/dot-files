...
plugins=(git brew aws bower frontend-search grunt jsontools node npm sublime gitfast terminalapp urltools zsh-per-directory-history zsh-syntax-highlighting zsh-history-substring-search)
